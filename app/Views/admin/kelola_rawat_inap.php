...
<!-- Tab Navigation -->
<div class="flex gap-1 mb-6 bg-slate-100 p-1 rounded-xl w-fit animate-in fade-in duration-300">
                ...
                <tbody class="divide-y divide-outline-variant/25 text-sm text-slate-700">
                    ...
                    <tr>
                        <td colspan="5" class="text-center text-slate-400 py-10">
                            <span class="material-symbols-outlined text-[40px] text-slate-300 block mb-1">check_circle</span>
                            Tidak ada pasien yang perlu dimasukkan ke kamar rawat inap.
                        </td>
                    </tr>
                    <?php else: ?>
                    ...
                    <tr class="hover:bg-slate-50/45 transition-colors">
                        ...
                        <td class="py-4 px-6 text-center">
                            <button type="button" onclick="openMasukModal('<?= esc($p['no_rawat'], 'js') ?>', '<?= esc($p['nama_pasien'], 'js') ?>')"
                                class="px-4 py-2 bg-secondary text-white text-xs font-bold rounded-xl hover:opacity-90 transition-all shadow-sm flex items-center gap-1 mx-auto">
                ...
                <tbody class="divide-y divide-outline-variant/25 text-sm text-slate-700">
                    ...
                    <tr>
                        <td colspan="7" class="text-center text-slate-400 py-10">
                            <span class="material-symbols-outlined text-[40px] text-slate-300 block mb-1">hotel</span>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-outline-variant/25 text-sm text-slate-700">
                    ...
                    <tr>
                        <td colspan="6" class="text-center text-slate-400 py-10">Belum ada riwayat rawat inap.</td>
                    </tr>
                    <?php else: ?>
...
<div id="modalPulang" class="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center opacity-0 pointer-events-none transition-all duration-300">
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden transform scale-95 transition-all duration-300">
        <div class="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-6 py-5 flex justify-between items-center">
            <div class="flex items-center gap-2.5">
