...
<div class="flex justify-between items-center mb-6 animate-in fade-in duration-300">
    <p class="text-sm text-slate-500">Manajemen kamar rawat inap rumah sakit</p>
    <button type="button" onclick="openModal('modalTambahKamar')" class="bg-secondary text-white hover:opacity-90 px-5 py-2.5 rounded-xl font-bold flex items-center gap-2 shadow-sm transition-all">
            ...
            <tbody class="divide-y divide-outline-variant/25 text-sm text-slate-700">
                ...
                <tr>
                    <td colspan="6" class="text-center text-slate-400 py-12">
                        <span class="material-symbols-outlined text-[48px] text-slate-300 block mb-2">meeting_room</span>
                        Belum ada data kamar. Tambahkan kamar untuk rawat inap.
                    </td>
                </tr>
                <?php else: ?>
