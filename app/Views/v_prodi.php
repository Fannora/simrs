        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?= base_url('/jurusan') ?>" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?= base_url('/prodi') ?>" class="nav-link active">
                    ...
                    <?php $nom=1; foreach ($prodi as $dt){ ?>
                        <tr>
                            ...
                            <td class="text-center">
                              <button type="button" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modal-edit-<?= $dt['kode_prodi'] ?>"><i class="fa fa-edit"></i></button>
                              <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-hapus-<?= $dt['kode_prodi'] ?>"><i class="fa fa-trash"></i></button>
                            </td>
                    </tr>
                    <?php } ?>
                  </tbody>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <select name="kode_jur" class="form-control">
                        <?php foreach($jurusan as $j) { ?>
                          <option value="<?= $j['kode_jur'] ?>"><?= $j['jurusan'] ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
            <div class="form-group row">
                    <label for="inputjurusan" class="col-sm-4 col-form-label">Nama Prodi</label>
                    <div class="col-sm-8">
...
<?php foreach ($prodi as $dt){ ?>
      <div class="modal fade" id="modal-edit-<?= $dt['kode_prodi'] ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <?= form_open('/editdataprodi') ?>
            <div class="modal-body">
              <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Kode Prodi</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="kode_prodi" placeholder="Kode Prodi" value="<?= $dt['kode_prodi'] ?>" readonly>
                    </div>
                  </div>
              <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Jurusan</label>
                    <div class="col-sm-8">
                      <select name="kode_jur" class="form-control">
                        <?php foreach($jurusan as $j) { ?>
                          <option value="<?= $j['kode_jur'] ?>" <?= $dt['kode_jur'] == $j['kode_jur'] ? 'selected' : '' ?>><?= $j['jurusan'] ?></option>
                        <?php } ?>
                      </select>
                    </div>
                  </div>
            <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="prodi" placeholder="Nama Prodi" value="<?= $dt['prodi'] ?>">
                    </div>
                  </div>
            </div>
            <div class="modal-footer justify-content-between">
      ...
      <div class="modal fade" id="modal-hapus-<?= $dt['kode_prodi'] ?>">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
              <a href="<?= base_url('/hapusdataprodi/'.$dt['kode_prodi']) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
