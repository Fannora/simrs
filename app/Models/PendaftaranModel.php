...
class PendaftaranModel extends Model
{
    ...
    protected $allowedFields    = ['no_rawat', 'no_rm', 'id_dokter', 'id_poli', 'tgl_daftar', 'jam_kunjungan', 'keluhan_awal', 'status_periksa', 'slot_waktu'];
    ...
    public function getPendaftaran()
    {
        return $this->db->table('tbl_pendaftaran')
            ...
            ->join('tbl_poli', 'tbl_poli.id_poli = tbl_pendaftaran.id_poli')
